...
const CheckpointCollapseReport = () => {
    ...
    const loadEndpointData = async (db_info) => {
        ...
        try {
            ...
            const auditorInfo = _.find(response.data.data[0].audit_pbd_users,{user_id : response.data.data[0].taken.audited_by})
            const reviewerInfo = _.find(response.data.data[0].audit_pbd_users,{user_id : response.data.data[0].taken?.reviewed_by})
            setauditorInfo(auditorInfo)
    ...
    const getSessionData = () => {
        ...
        console.log('publishedAuditData! :>> ', publishedAuditData, auditData);
                ...
                .post("epadtprcs/getepcheckpoints", {
                    ...
                    if (response.data.response_code === 500) {
                        ...
                        const nonCompliantCheckpoints = checkpoints.filter((checkpoint) => {
                            return checkpoint.cp_compliance?.id.toLowerCase() === "2";
                        });
            ...
            <React.Fragment>
                <div className={isBlurLoading ? 'page-content  blur' : 'page-content'} id='content'>
                    ...
                    <Breadcrumbs
                        ...
                        description={endpointData?.loc_name + " / " + endpointData.code}
                    ...
                    <Container fluid>
                                                            ...
                                                            <div id="overview">
                                                                <Card style={{ marginBottom: 0, borderRadius: "0.5rem", border: '1px solid lightgrey' }} className="mt-1">
                                                                    <CardBody className="py-0">
                                                                        ...
                                                                        {
                                                                            <Row style={{ borderTop: "1px solid lightgrey" }} className="py-3 gap-3 justify-content-between">
                                                                                {
                                                                                    ...
                                                                                    <>
                                                                                            ...
                                                                                            <div>
                                                                                                <label style={{ fontSize: "1rem", }} className="fw-bold" >
                                                                                                    ...
                                                                                                    {endpointData.audit_score !==
                                                                                                        ...
                                                                                                        <>
                                                                                                            {Number(
                                                                                                                endpointData.audit_score?.$numberDecimal
                                                                                                            ).toFixed(2)}{" "}
                                                                                        ...
                                                                                        <Col className="col-auto"  >
                                                                                            ...
                                                                                            <div>
                                                                                                <label style={{ fontSize: "1rem" }} className="fw-bold" >
                                                                                                    {endpointData.min_score?.$numberDecimal !==
                                                                                                        undefined &&
                                                                                                        endpointData.min_score?.$numberDecimal !==
                                                                                                        "undefined" &&
                                                                                                        endpointData.min_score?.$numberDecimal !== null ? (
                                                                                                        <>
                                                                                                            {Number(
                                                                                                                endpointData.min_score?.$numberDecimal
                                                                                                            ).toFixed(2)}
                                                                                        ...
                                                                                        <Col className="col-auto" >
                                                                                            ...
                                                                                            <div>
                                                                                                <label style={{ fontSize: "1rem" }} className="fw-bold" >
                                                                                                    {endpointData.max_score?.$numberDecimal !==
                                                                                                        undefined &&
                                                                                                        endpointData.max_score?.$numberDecimal !==
                                                                                                        "undefined" &&
                                                                                                        endpointData.max_score?.$numberDecimal !== null ? (
                                                                                                        <>
                                                                                                            {Number(
                                                                                                                endpointData.max_score?.$numberDecimal
                                                                                                            ).toFixed(2)}
                                                                                ...
                                                                                {
                                                                                    // _.filter(endpointData.audit_pbd_users,{audit_type :"2"}).length >0
                                                                                    endpointData.audit_config.enable_review 
                                                                                     ?
                                                                                        <>
                                                                                            <Col className="col-auto">
                                                                                                <div className="text-secondary font-size-12">Audited by:</div>
                                                                                                <div style={{ fontSize: "1rem" }} className="fw-bold" >{auditorInfo?.name}</div>
                                                                                            </Col>
                                                                                            <Col className="col-auto">
                                                                                            ...
                                                                                            <Col className="col-auto">
                                                                                                ...
                                                                                                <div style={{ fontSize: "1rem" }} className="fw-bold" >{reviewerInfo?.name ?reviewerInfo?.name :"-" }</div>
                                                                                            </Col>
                                                                                            <Col className="col-auto">
                                                                                                ...
                                                                                                <div style={{ fontSize: "1rem" }} className="fw-bold" >
                                                                                                    {
                                                                                                        endpointData.audit_reviewed_on !== null ?
                                                                                                            ...
                                                                                                            :
                                                                                                            <span className={"badge badge-soft-danger font-size-11 m-1"} > {"Not Submitted"} </span>
                                                                                                    }
                                                                                                </div>
                                                                                            </Col>
                                                                                        ...
                                                                                        <tr key={i} >
                                                                                            ...
                                                                                            <td className="text-center">
                                                                                                {item.cp_actionplans.length !== 0 ?
                                                                                                    <i className="mdi mdi-arrow-right font-size-20 text-primary" style={{ cursor: 'pointer' }} onClick={() => onShowActionPlan(item)}></i>
                                                                                                    :
                                                                                            ...
                                                                                            <td className="fw-bold font-size-14">
                                                                                                {item.max_score?.$numberDecimal}
                                                                                            </td>
                                                                                            <td className="fw-bold font-size-14">
                                                                                                {item.min_score?.$numberDecimal}
                                                                                            </td>
                                                                                            <td className="fw-bold font-size-14">
                                                                                                {item.cp_otpion_score?.$numberDecimal !== undefined && item.cp_otpion_score?.$numberDecimal !== null ? parseFloat(item.cp_otpion_score?.$numberDecimal).toFixed(2) : 'No Score'}
                                                                                            </td>
                                                                                            <td className="fw-bold font-size-14">
                                                                                                {item.cp_otpion_score !== undefined && item.cp_otpion_score !== null
                                                                                                    ? (item.cp_otpion_score?.$numberDecimal / item.max_score?.$numberDecimal * 100).toFixed(2)
                                                                                                    : 'No Score'}
                                                                                            </td>
                                                                                            <td className="fw-bold font-size-14">
                                                                                                {(item.max_score?.$numberDecimal - (item.cp_otpion_score?.$numberDecimal !== undefined && item.cp_otpion_score?.$numberDecimal !== null
                                                                                            ...
                                                                                            <td className="fw-bold font-size-14">
                                                                                                {((item.max_score?.$numberDecimal - (item.cp_otpion_score?.$numberDecimal !== undefined && item.cp_otpion_score?.$numberDecimal !== null
                                                                                                    ? parseFloat(item.cp_otpion_score?.$numberDecimal)
                                                                                                    : 0)) / item.max_score?.$numberDecimal * 100).toFixed(2)}
                                                                                            </td>
                        ...
                        <Modal size="lg" isOpen={showActionPlanModal} toggle={() => { setShowActionPlanModal(false); setActionPlanData([]) }}>
                        <div className="modal-header">
                            <h6 className="modal-title">Actionplan : </h6>
                            <button type="button" className="close" onClick={() => { setShowActionPlanModal(false); setActionPlanData([]) }}>
                        ...
                        <div className="">
                            <Card>
                                <CardBody>
                                    <h5>{selectedCheckpoint?.checkpoint}</h5>
                                    <label className="font-size-12">Corrective And Preventive Action(CAPA)</label>
                                    <PreviewCAPA actionplans={selectedCheckpoint?.cp_actionplans} />
                                </CardBody>
                            </Card>
                        </div>
                    </Modal>
