            ...
            {images.map((item, idx) => (
                <Col key={idx}>
                    {item.filetype === "application/zip" ? (
                        <Col>
                            <Link to={`//${imagePreviewUrl}${props.folderPath}${item.preview}`} target="_blank" download>
                        ...
                        <Col>
                            <a href={`${imagePreviewUrl}${props.folderPath}${item.originalName}`} target="_blank" rel="noreferrer">
