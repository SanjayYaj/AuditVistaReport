...
function GlobalFilter({
  ...
  return (
    <React.Fragment>
      <Col sm="4">
        <input type="search" className="form-control" id="search-bar-0" value={value || ""} placeholder={`Search Location / Asset Name.. `} onChange={e => { setValue(e.target.value);filteredValue(e.target.value); onChange(e.target.value) }} />
      </Col>
  ...
  return (
    <Fragment>
      ...
      <Row className="">
        ...
        {/* Empty Column for spacing, can be used later for additional elements */}
        ...
        <Col sm="4" className="d-flex justify-content-end align-items-center">
          <div className="d-flex align-items-center">
            ...
            {publishedAuditData.repeat_mode_config.mode_id === "0" && (
              <Button
                onClick={() => onClickChangeAuditEndDate()}
                className="btn-sm d-flex align-items-center"
                color="primary"
                type="button"
              >
                <i className="bx bx-calendar me-1" style={{ fontSize: '18px' }} />{" "}
