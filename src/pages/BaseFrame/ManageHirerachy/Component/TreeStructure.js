...
const crudNodeInfo = async (event, values) => {
    ...
    if (!validateNode) {
        ...
        // ADD THIS LOGIC TO AUTOMATICALLY SET h_node_type
        if (selectedNodeType === "1") {
            values["h_node_type"] = { id: "1", name: "Location" }
        } else if (selectedNodeType === "2") {
            values["h_node_type"] = { id: "2", name: "Asset" }
        } else if (values.h_node_type) {
            // This handles manual selection from dropdown
        ...
        try {
            ...
            // SUCCESS: Close all dropdowns and reset states
            setDropdownStates({});
            setdropdownStatesEdit({});
            dispatch(setState({ mainToggle: false }));
            ...
            setselectedNodeType(""); // RESET SELECTED NODE TYPE
            
            if (optionRef.current) {
                optionRef.current.value = "0";
            }
            
            console.log("Form submitted successfully and dropdowns closed");
                                ...
                                <div className="row" style={{ borderBottom: "1px solid #dedede" }}>
                                    <div className="mb-2 col-10 ">
                                        <UncontrolledDropdown isOpen={state.mainToggle} toggle={toggle}>
                                            {canEdit && (<>
                                                <DropdownToggle className="btn btn-sm btn-buttonPrimaryE d-flex align-items-center" color="#eff2f7" onClick={() => { dispatch(setState({ path: [], crud: true, crudStatus: 0, type: 0, children: [], mainToggle: true })); setenableCode(false); setinvalidTittle(false); setselectedNodeType("1") }} >
                                                ...
                                                <div className="px-4">
                                                    <AvForm onValidSubmit={crudNodeInfo}>
                                                        <div className="my-2">
                                                            <AvField name="title"
                                                                // label="Location Name "
                                                                label={<>Location Name <span className="text-danger">*</span></>}
                                            ...
                                            return {
                                                ...
                                                subtitle: (
                                                    <div style={{ height: '100%', width: '100%', marginTop: 4, marginLeft: node.type == 1 || node.type == 2 ? 28 : 0 }} >
                                                        ...
                                                        {node.cat_type === undefined ? (
                                                            node.node_positon !== node.subtitle
                                                                ? `${node?.subtitle || ""} (${node.node_positon})`
                                                                : node?.subtitle
                                                        ) : (
                                                            node.cat_type == "1"
                                                                ? "Auditer"
                                                ...
                                                buttons: [
                                                    <Row className="" key={node.id}>
                                                        ...
                                                        <ul className="list-unstyled hstack gap-1 mb-0 justify-content-end">
                                                            ...
                                                            {node.type === 0 && node.h_node_type?.id !== "2" && (
                                                            ...
                                                            {(node.type === 0 || node.h_node_type?.id === "1") &&  (
                                                                <UncontrolledDropdown direction="end" isOpen={dropdownStates[`asset-${node.id}`]} toggle={() => toggleDropdown(`asset-${node.id}`)}>
                                                                    {canEdit && (<>
                                                                        <DropdownToggle className="card-drop" tag="a">
                                                                        ...
                                                                        <DropdownMenu className="ms-4 " style={{ minWidth: "500px", zIndex: 2, padding: 10, marginLeft: '13px', marginTop: '-15px' }}>
                                                                            <div className="px-4">
                                                                                ...
                                                                                <AvForm onValidSubmit={async (event, values) => {
                                                                                    try {
                                                                                        await crudNodeInfo(event, values);
                                                                                        // Additional cleanup specific to asset form
                                                                                        toggleDropdown(`asset-${node.id}`); // Close this specific dropdown
                                                                                    } catch (error) {
                                                                                    ...
                                                                                    <div className="my-2">
                                                                                        <AvField name="title"
                                                                                            label={<>Asset Name <span className="text-danger">*</span></>}
                                                                                    ...
                                                                                    <div className="mt-3 text-end">
                                                                                        <button
                                                                                            disabled={invalidTittle}
                                                                                            className="btn btn-sm btn-outline-primary btn-block m-1"
                                                                                            type="submit"
                                                                                            style={{ marginRight: 5 }}
                                                                                        >
                                                                                            Add Asset
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                {canEdit && (<>
                                                                                    ...
                                                                                    <div className="d-flex align-items-center justify-content-end gap-2 my-1">
                                                                                         { nodeUsers.length > 0 ?
                                                                                         ( <button className="btn btn-sm btn-outline-danger btn-sm" onClick={() => deleteAllUsers(state.nodeInfo, authUser.db_info)}> Delete all Users 
                                                                                          </button> ) : (null) }
                            ...
                            <OffcanvasBody>
                                {
                                    state.editcrud ?
                                        <div className="px-4">
                                            <div className="mt-1" style={{ display: 'inline-flex' }}>Edit Node Name : </div>
                                            ...
                                            <div className="font-size-11 text-dark" style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '100%', cursor: 'pointer' }}>
                                                {truncateText(state.getNodeInfo?.subtitle || '', 8)}
                                            </div>
                                            <AvForm ref={formRef} onValidSubmit={
                                                ...
                                                <div className="my-2">
                                                    ...
                                                    />
                                                    {
                                                        ...
                                                        <div className="mb-3">
                                                            <Label className="" htmlFor="autoSizingSelect">Choose Type<span className='text-danger'>*</span></Label>
                                                            <AvInput
                                                                type="select"
                                                                name="h_node_type"
                                                                className="form-select"
