...
function GlobalFilter({
    ...
    return (
        <React.Fragment>
            <Col xxl={3} lg={6}>
                <input type="search" style={{ borderRadius: 25 }} className="form-control" id="search-bar-0" value={value || ""} placeholder={`Search Role`} onChange={e => { setValue(e.target.value); onChange(e.target.value) }} />
            </Col>
                ...
                {dynamicBtn && canEdit && (
                    <Col className="d-flex align-items-center justify-content-end">
                        <div className="d-flex align-items-center justify-content-end gap-1">
                            <Button onClick={() => { btnClick() }} className="btn-sm px-3" color="buttonPrimaryE" type="button">
                                {btnName}
                            </Button>
                        </div>
                                ...
                                {headerGroups.map(headerGroup => (
                                    <tr key={headerGroup.id} {...headerGroup.getHeaderGroupProps()}>
                                        {headerGroup.headers.map((column, index) => (
                                            ...
                                            >
                                                <div className="m-0" {...column.getSortByToggleProps()} style={{ fontWeight: 500 }}>
