...
function GlobalFilter({
  ...
  return (
    <React.Fragment>
      <Col xxl={3} lg={6}>
        <input type="search" className="form-control" id="search-bar-0" value={value || ""} placeholder={`Search Actions plans audit name...`} onChange={e => { setValue(e.target.value); onChange(e.target.value) }} />
      </Col>
